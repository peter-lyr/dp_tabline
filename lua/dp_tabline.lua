...
function M.titlestring(ev)
  ...
  local root_head = B.get_short(B.get_only_name(B.file_parent(project)), 2, '.')
  local root = B.get_short(B.get_only_name(project), 4, '.')
  local branchname = ' ' .. B.get_short(vim.fn['gitbranch#name'](), 3, '.')
